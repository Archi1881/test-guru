...
users = User.create!([
  {name: 'Archi', first_name: 'Artur', last_name: 'Gilim', email: 'art.test@gmail.com', password: 123456789, type: 'Admin' },
  {name: 'TIM', first_name: 'TIMUR', last_name: 'UGIZOVICH', email: 'tim.test@gmail.com', password: 123456789 }
  ])
